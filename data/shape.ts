/**
 * Declared quality and demo-behaviour ranges for the BNC-backed register. The generator measures every one
...
export const SHAPE_TARGETS: ShapeTarget[] = [
  ...
  { key: 'mepConsultantFill', label: 'BNC rows with an MEP consultant', lo: 25, hi: 35, unit: 'percent', basis: 'Import regression guard for the supplied workbooks' },
  { key: 'mainContractorFill', label: 'BNC rows with an appointed main or EPC contractor', lo: 32, hi: 45, unit: 'percent', basis: 'Import regression guard after treating “Not Yet Awarded” and “See Sub-Projects” as absent, not as company names' },
  { key: 'mepContractorFill', label: 'BNC rows with an MEP contractor', lo: 20, hi: 32, unit: 'percent', basis: 'Import regression guard for the supplied workbooks' },
  { key: 'consultantMedian', label: 'Consultant source-label book, median', lo: 1, hi: 2, unit: 'projects', basis: 'BNC company cells are preserved intact; many labels occur on one project' },
  ...
  { key: 'contractorMedian', label: 'Contractor source-label book, median', lo: 1, hi: 2, unit: 'projects', basis: 'BNC company cells are preserved intact; many labels occur on one project' },
