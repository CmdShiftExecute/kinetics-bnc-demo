...
const checks: Array<[string, boolean, string]> = [
  ...
  ['p10 near the BNC source shape', q(0.1) >= 0.5 && q(0.1) <= 2, `${q(0.1)}m`],
  ['median near the BNC source shape', q(0.5) >= 12 && q(0.5) <= 18, `${q(0.5)}m`],
  ['p90 near the BNC source shape', q(0.9) >= 220 && q(0.9) <= 320, `${q(0.9)}m`],
  ['largest project within the BNC source maximum', values.at(-1)! <= 27_000, `${values.at(-1)}m`],
