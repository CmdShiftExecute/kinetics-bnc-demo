...
export default function ProjectPage() {
  ...
  if (!p) return <PageError message={`No such project: "${ref}". References look like ${rollup.chase[0]?.ref ?? 'AE7K3MQ9X'}; every project is listed on the Projects page.`} back={{ to: '/projects', label: 'Back to the projects' }} />;
    ...
    <div className="wrap">
      ...
      <Section id="description" title="Description">
        ...
        <p className="muted" style={{ fontSize: 11 }}>
          Register record {p.ref} of {count(rollup.kpis.projects)}. Project and company fields trace to the supplied workbook; the internal relevance, ownership, relationship and activity layer is illustrative and reconciled on the Data basis page.
        </p>
      </Section>
      <Footer meta={meta} />
    </div>
